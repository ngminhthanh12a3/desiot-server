...
module.exports = class FrameHandler {
  ...
  async parseFrame() {
    ...
    this.timeLabel = `[${Date.now()}] - Communication End`;
    this.DESIoTConsole.time(this.timeLabel);
    if (
  ...
  async handleSuccessFrame() {
    this.DESIoTConsole.timeEnd(this.timeLabel);
