module.exports = class DESIOT_FRAME {
  ...
  static T1_DEFAULT = 0x70;
  static T2_DEFAULT = 0x71;
  //
  static H1_INDEX = 0;
  static H2_INDEX = 1;
  static CMD_INDEX = 2;
  ...
  static CMD_DEVICE_READ_VIRTUAL_STORAGE = 2;
  ...
  static VS_TYPE_FLOAT = 1;
  static VS_TYPE_STRING = 2;
  static VS_TYPE_FLOAT_ARR = 3;

  // ENCRYPT
  static ENCRYPT_ENABLE = true;
  static TAG_SIZE = 16;
};
